...
In der folgenden Übersicht, gehe ich jedoch nur noch auf die gängigsten GPT-Modelle in Azure ein.
...
**Wichtig**: Nicht alle Modelle sind über alle Bezugskanäle verfügbar. Die Llama Modelle zum Beispiel gibt es nur, wenn man Azure über einen EA-Vertrag beziegt. Weder über CSP noch über eine Kreditkarte ist dieses Modell im AI Foundry Portal zu deployen.
